                ...
                <div class='row'>
                    <div class='container'>
                        <div class="slick-desc">
                            //someething like this, but doesn't work :(
                            <?php
                            ...
                            ?>
                                           <div class="col-md-4">
                                            <div class="desc-div">
                                                <img class="img-responsive" src='"<?php $row['image'] ?>"'/>
                                                <h4><?php $row['category'] ?></h4>
                                                <h5><?php $row['title'] ?></h5>
                                                <p><?php $row['text'] ?></p>
                                            </div>
                                        </div>
                            ...
                            <div class="col-md-4">
                                <div class="desc-div">
                                    ...
                                    <h4>MILESTONE</h4>
                                    <h5>Taleb school system tracking 8000 students</h5>
                                    <p>In hac habitasse platea dictumst.<br> Vivamus adipiscing farmentum quam<br> volutpat aliquam...</p>
                                </div>
                            </div>
                            <div class="col-md-4">
                                <div class="desc-div">
                                    ...
                                    <p>Curabltur lobortis id lorem id bibendum. Ut id consecteur magna.
                                       Quisque volutpat...</p>
                                </div>
                            </div>
                             <div class="col-md-4">
        ...
        <div class='container-fluid blue-row'>
            <div class='row'>
                <div class='container'><div class='col-md-9'>
                    <p>Check how we can kickstart smart projects</p>
                    </div>
                    <div class='col-md-1'><img src="images/arrow.svg" alt="image not found"/></div>
                </div>
            </div>
        </div>
